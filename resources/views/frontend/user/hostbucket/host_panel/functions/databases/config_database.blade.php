        ...
        <div class="container-fluid px-xxl-65 px-xl-20">
          ...
          'breadcrumb' => [
                  ...
                  [
                   ...
                   [
                      'name' =>$database_name,
                      'url' => route('frontend.user.hostbucket.config_database',[$hosting_details->id,$database_name]),
                      'is_active' => null
                  ]
           ]
          ])
        ...
        <!-- Tab panes -->
            <div class="tab-content">
                <div class="tab-pane active" id="tabs-1" role="tabpanel">
                    @include('frontend.user.hostbucket.host_panel.sections.config_database')
                </div>
            </div>
        </div>
    </div>
