...
<link rel="stylesheet" href="{{url('css/map_stacker.css')}}">

<div class="" style="background: #4d90fe;">
    <div class="Map-container" style="padding-top: 40px;padding-bottom: 40px;">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
          ...
          l25.7-25h15.9l12.5-13.1l5.7,6.1h8.2l-0.1,16.5l-8.9,9.5h30.2l8.8,9h44l14.3,14h16.3l2.3-3h15.5l10.3,11.4L654,142.2z"></path>
                ...
                <div class="col-md-6">
                    <h2 style="color: white;">World Wide Covered our servers</h2>
                    <p style="color: white;">Few would argue that, despite the advancements of feminism over the
                        past three decades, women still face a double standard when it comes to
                        their behavior. While men’s borderline-inappropriate behavior.</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <nav class="Location-nav js-Location-nav" style="width: 200px;">
                                <ul>
                                    <li data-location="NY">New York</li>
                                    <li data-location="SF">San Francisco</li>
                                    <li data-location="TR">Toronto</li>
                                    <li data-location="LN">London</li>
                        ...
                        <div class="col-md-6">
                            <nav class="Location-nav js-Location-nav" style="width: 200px;">
                                <ul>
                                    ...
                                    <li data-location="FR">Frankfurt</li>
                                    <li data-location="AM">Amsterdam</li>
                                    <li data-location="SP">Singapore</li>
