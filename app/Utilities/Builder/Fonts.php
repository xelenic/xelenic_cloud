...
class Fonts {
   ...
   public function __construct() {
    ...
    protected function _getFontDeclaration($ext, $file, $path) {
        switch ($ext) {
            case "svg":
                return "\tsrc: url('..//fonts/$file#ciclefina') format('svg');\n";
            case "woff":
                return "\tsrc: url('..//fonts/{$file}') format('woff');\n";
    //                    "\t\turl('..//fonts/$path/$file') format('woff2');\n";
                break;
            case "eot":
                return "\tsrc: url('..//fonts/$file');\n".
                    "\tsrc: url('..//fonts/$file?#iefix') format('embedded-opentype');\n";
            default:
            case "ttf":
                return "\tsrc: url('..//fonts/$file') format('truetype');\n";
        }
    }
