...
namespace App\Http\CpanelFunctions;


class CpanelCore
{
    public function __construct($cpanelUrl, $cpaneluser, $cpanelPwd, $cpanelKey, $cpanelPort = '2083') {
        $this->cPanelUser = $cpaneluser;
        $this->cPanelPwd = $cpanelPwd;
        $this->cPanelUrl = $cpanelUrl;
        $this->cPanelPort = $cpanelPort;
        $this->cPanelKey = $cpanelKey;
    }
    ...
    public function repairDataBaseMysql($database)
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Mysql/repair_database?name=$database";
        return $this->exe_cpanel($func);
    }

    public function getAllDatabasesMySQL()
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Mysql/list_databases";
        return $this->exe_cpanel($func);
    }
    public function getMySQLServerInfo()
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Mysql/get_server_information";
        return $this->exe_cpanel($func);
    }
    ...
    public function listUserMySQL()
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Mysql/list_users";
        return $this->exe_cpanel($func);
    }
    ...
    public function addUserPrivilage($usernameDB,$database,$privilages)
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Mysql/set_privileges_on_database?user=$usernameDB&database=$database";
        return $this->exe_cpanel($func);
    }
    public function remoteSQL()
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Mysql/get_host_notes";
        return $this->exe_cpanel($func);
    }
    public function remoteSQLDeleteHostAccess($host)
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Mysql/delete_host?host=$host";
        return $this->exe_cpanel($func);
    }

    public function remoteSQLHostAdd($host)
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Mysql/add_host_note?host=$host&note=hpaliem";
        return $this->exe_cpanel($func);
    }
    ...
    public function deleteGitRepo($repository_root)
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/VersionControl/delete?repository_root=$repository_root";
        return $this->exe_cpanel($func);
    }
    ...
    public function file_manager($file_path)
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Fileman/list_files?dir=$file_path";
        return $this->exe_cpanel($func);
    }
    public function file_manager_killDir($file_path)
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Fileman/fileop?dir=$file_path";
        return $this->exe_cpanel($func);
    }

    public function file_manager_upload_file($dir,$file_name)
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Fileman/upload_files?dir=$dir&file=$file_name";
        return $this->exe_cpanel($func);
    }

    public function file_manager_save($file_name,$dir,$content)
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Fileman/save_file_content&file=$file_name&content=$content&dir=$dir";
        return $this->exe_cpanel($func);
    }
    ...
    {
        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Ftp/list_ftp";
        return $this->exe_cpanel($func);
    }
    ...
    private function exe_cpanel($func = '') {
        try{
            ...
            $header[0] = "Authorization: cpanel $this->cPanelUser:$this->cPanelKey";
